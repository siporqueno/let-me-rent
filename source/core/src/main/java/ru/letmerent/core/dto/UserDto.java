...
public class UserDto {
    ...
    @NotBlank(message = "Заполните адрес электронной почты. Данное поле не может быть пустым")
    ...
    @NotBlank(message = "Укажите логин. Данное поле не может быть пустым")
    ...
    @NotBlank(message = "Укажите пароль. Данное поле не может быть пустым")
    ...
    @NotBlank(message = "Укажите подтверждение пароля. Данное поле не может быть пустым")
    @Size(min = 3, max = 16, message = "Пароль должен быть от 3х до 16-ти символов")

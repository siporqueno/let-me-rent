...
public class CartService {
    ...
    private Map<String,Cart> cartsInApplicationMemory = new HashMap<>();
    ...
    public Cart getCurrentCart(String cartKey) {
        if (!cartsInApplicationMemory.containsKey(cartKey)) {
            cartsInApplicationMemory.put(cartKey, new Cart());
        }
        return cartsInApplicationMemory.get(cartKey);
    }
    ...
    private void execute(String cartKey, Consumer<Cart> action) {
        ...
        action.accept(cart);
        cartsInApplicationMemory.put(cartKey, cart);
    }
    ...
    //КОД Я ПИСАЛА ДЛЯ ВАРИАНТА С REDIS
